...
export const metadata: Metadata = {
  ...
  description: "Welcome to groovex – Your one-stop shop for quality products at affordable prices. Explore our wide range of items and enjoy fast delivery and excellent customer service.",
  keywords: [
    "groovex",
    "e-commerce",
    "buy online",
  ...
  openGraph: {
    title: `${site.name} | Buy Quality Products at Affordable Prices`,
    description: "Welcome to groovex – Your one-stop shop for quality products at affordable prices. Explore our wide range of items and enjoy fast delivery and excellent customer service.",
    url: "https://groovex.co.in", // Replace with your actual website URL
    siteName: site.name,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "groovex - Quality Products at Affordable Prices",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://groovex.co.in", // Replace with your actual canonical URL
  },
  icons: {
